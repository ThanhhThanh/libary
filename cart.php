                                                    ...
                                                    <tbody>
                                                            ...
                                                            <tr class="cart_item">
                                                                ...
                                                                <td class="product-thumbnail">
                                                                    <a href="detail.php?id=<?php echo $value['id'] ?>&type_id=<?php echo $value['type_id'] ?>"><img width="145" height="145" alt="poster_1_up" class="shop_thumbnail" src="img/<?php echo $value['image'] ?>"></a>
                                                                </td>
